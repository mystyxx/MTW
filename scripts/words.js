...
const quote1 = 'Dans la vie, on ne fait pas ce que l\'on veut, mais on est responsable de ce que l\'on est.'.match(/\S+\s*/g);
const quote2 = 'La vie est un mystère qu\'il faut vivre, et non un problème à résoudre.'.match(/\S+\s*/g);
const quote3 = 'Parfois, c\'est compliqué de faire la différence entre détermination et obstination.'.match(/\S+\s*/g);
const quote4 = 'Malgré tout, ça reste toi.'.match(/\S+\s*/g);
const quote5 = 'Tu possèdes quelque chose qui s\'appelle la détermination. Donc du moment que tu t\'accroches, du moment que tu fais ce qui te tient à coeur, je crois que tu peux faire ce qui est juste.'.match(/\S+\s*/g)
const quote6 = 'Be proud of you, because we can be do what we want to do.'.match(/\S+\s*/g);
...
const quote8 = 'Quelle est la différence entre toi et moi ? C\'est que moi je compte encore les jours et toi je sais bien que tu les comptes pas.'.match(/\S+\s*/g);
const quote9 = 'Y en a qui se la jouent viril, glorifiant la loi du plus fort, mais leur connerie est sidérale, ça pédale dans la semoule, dans l\'aigreur intersidérale. Y en a qui rabaissent les meufs, voudraient les voir dans la cuisine, ça rassure leur égo quand ils les voient courber l\'échine.'.match(/\S+\s*/g);
const quote10 = 'Y en a qui disent \"j\'ai été trop gentil maintenant fini de sfaire avoir\" mais c\'est en disant ça qu\'ils rejoignent le troupeau des batards.'.match(/\S+\s*/g)
const quote11 = 'On est le flip flip crew, terroristes bienveillants, les autres trucs c\'est chiant, va falloir vous réveiller, car nous sommes l\'understup, la ligue anti-réactionnaire, le stup persévère, stoppera les guerres sur la Terre.'.match(/\S+\s*/g);
const quote12 = 'Fais confiance qu\'à ton coeur, avant d\'apprendre à rire on pleure, après la vie on meurt, lève-toi, prends les armes et bat toi pour tes valeurs.'.match(/\S+\s*/g);
...
const quote14 = 'Le cinéma est un art du spectacle. En français, il est désigné commme le "septième art", d\'après l\'expression du critique Ricciotto Canudo dans les années 1920. L\'art cinématographique se caractérise par le spectacle proposé au public sous la forme d\'un film, c\'est à dire d\'un récit (fictionnel ou documentaire, véhiculé par un support (pellicule souple, bande magnétique, contenant numérique), qui est enregistré puis lu par un mécanisme continu ou intermittent qui crée l\'illusion d\'images en mouvements, ou par l\'enregistrement et la lecture continue de données informatiques.'.match(/\S+\s*/g);
const quote15 = 'Quoi que je fasse, quelle que soit ma détermination, ceux que j\'aime finiront toujours par payer.'.match(/\S+\s*/g);
const quote16 = 'Tu sais, si tu as l\'intention de voler des voitures, ne te déguise pas en voleur de voiture.'.match(/\S+\s*/g);
const quote17 = 'Nombreux sont les vivants qui mériteraient la mort, et les morts qui mériteraient la vie, pouvez-vous la leur rendre Frodon ? Alors ne soyez pas trop prompt à dispenser morts et jugements. Même les grands sages ne peuvent connaître toutes les fins.'.match(/\S+\s*/g);
const quote18 = 'C\'était assurément une puissante citadelle, imprenable pour peu qu\'elle fût tenue par des gens en état de porter les armes, à moins que quelque ennemi ne pût venir par derrière, escalader les pentes inférieures du Mindolluin et parvenir ainsi sur l\'étroit épaulement qui joignait la Colline de la Garde à la masse de la montagne. Mais cet épaulement, qui s\'élevait à la hauteur du cinquième mur, était entouré de grands remparts jusqu\'au bord même du précipice qui surplombait son extrémité occidentale, et dans cet espace s\'élevaient les demeures et les tombeaux à dôme des rois et seigneurs du temps passé, à jamais silencieux entre la montagne et la tour.'.match(/\S+\s*/g);
const quote19 = 'Le quenya fut conçu par Tolkien comme dérivant d\'une langue originelle commune à toutes les langues elfiques qu\'il imagina. C\'est une langue à morphologie complexe, qui présente à la fois des traits flexionnels et agglutinants ; elle repose en grande partie sur l\'emploi d\'affixes, mais recourt aussi à l\'alternance vocalique. Le quenya est pourvu d\'une riche déclinaison et d\'une conjugaison de type synthétique. Le nombre de cas et la conjugaison ont varié avec les années au cours du développement de la langue par leur auteur. Le vocabulaire est essentiellement a priori, c\'est-à-dire créé indépendamment de celui des langues naturelles, mais il est en revanche apparenté à celui des autres langues elfiques imaginées par Tolkien.'.match(/\S+\s*/g);
const quote20 = 'Xavier, Bruno, Hervé Niel, né le 15 août 1967 à Maisons-Alfort (France), est un homme d\'affaires miliardaire français. Sa fortune est estimée à 8,6 miliards de dollars par le magazine américain Forbes au premier mars 2023. Il est le fondateur et actionnaire principal d\'Iliard, groupe de télécommunications français, maison mère du fournisseur d\'accès à internet Free et de l\'opérateur de téléphonie mobile FRee mobile. Il est à ce titre, au début des années 2000, le pionnier en France des offres du triple play et du concept de box. Xavier Niel est également, à titre personnel, copropriétaire du groupe Le monde (propriétaire du journal homonyme) et investisseur dans plusieurs secteurs d\'activité. Membre du Conseil national du numérique de 2011 à 2012, instigateur des établissements d\'autoformation en informatique 42, il est aussi à l\'origine du projet Station F à Paris.'.match(/\S+\s*/g);
const quote21 = 'L\'existence du kipferi, ancêtre du croissant, serait attestée dans les pays de l\'Europe de l\'Est depuis le XIIIe siècle, mais sans que l\'on en connaisse la recette (salée ou sucrée) et fait dans une pâte à brioche. On daterait son origine à 1683 où, pendant que les Turcs assiègent Vienne, un boulanger prénommé Adam Spiel donne l\'alerte au moment d\'une attaque ottomane à l\'aube qui permet de repousser l\'envahisseur. Pour commémorer cette victoire, de petits croissants appelés Hörnchen furent confectionnés par les boulangers de la ville, rappelant ainsi la forme du symbole ottoman.'.match(/\S+\s*/g);
const quote22 = 'Le Guide du voyageur galactique (titre original : The Hitchhiker\'s Guide to the Galaxy, abrégé notamment en H2G2) est une oeuvre de science-fiction humoristique mulidisciplinaire imaginée par l\'écrivain britannique Douglas Adams. Son nom provient de l\'object symbolique de la série : un livre électronnique intitulé Le Guide du vogateur galactique. Née en 1978 sous forme de feuilleton radiophonique, l\'oeuvre a depuis été déclinée dans de nombreux médias au cours de différentes adaptations : romans, pièces de théâtre, série télévisée, jeux vidéo, bande dessinée, long métrage pour le cinéma.'.match(/\S+\s*/g);
const quote23 = 'Il est écrit "Seul Link peut vaincre Ganon" !'.match(/\S+\s*/g);
const quote24 = 'Dieu a-t-il fait l\'Homme à son image ou L\'Homme a-t-il fait Dieu à la sienne ? J\'ai mon avis. La religion traduit les aspirations profondes de la race humaine. Nulles qu\'elles n\'ont davantage façonné l\'histoire. Ce cycle nous tente à en tirer des leçons. Devenir de meilleurs croyants ou de meilleurs athées, ça signifie avant tout "regarder au plus profond de nous pour ne pas reproduire les erreurs du passé."'.match(/\S+\s*/g);
const quote25 = 'Si la jeunesse n\'a pas toujours raison, la société qui la méconnaît et qui la frappe a toujours tort.'.match(/\S+\s*/g);
const quote26 = 'Vous avez tout à fait raison, Monsieur le Premier Ministre...'.match(/\S+\s*/g);
const quote27 = 'Moi, je n\'étais rien et voilà qu\'aujourd\'hui, je suis le gardien du sommeil de ses nuits, je l\'aime à mourir... Vous pouvez détruire tout ce qu\'il vous plaira, elle n\'a qu\'à ouvrir l\'espace de ses bras, pour tout reconstruire... Pour tout reconstruire...'.match(/\S+\s*/g);
const quote28 = 'La première étape du Tour de France 1952 s\'est déroulée le 25 juin 1952 entre les villes de Brest, qui accueille pour la première fois le départ d\'un Tour, et de Rennes, qui est une ville-étape du Tour pour la sixième fois de son histoire. Le parcours franchit les reliefs bretons à travers les départements du Finistère, des Côtes-du-Nord et de l\'Ille-et-Vilaine, sur une route accidentée longue de 246 km. Il passe notamment les villes de Morlaix, Guingamp et Saint-Brieuc. Cette première étape des vingt-trois prévues lance la 39e édition du Tour de France, dont Fausto Coppi prend le départ dans le rôle de l\'immense favori en l\'absence d\'Hugo Koblet, vainqueur de l\'édition précédente, et de Louison Bobet, alors champion de France. La course est remportée par le Belge Rik Van Steenbergen devant son compatriote et coéquipier Maurice Blomme, tous les deux membres de l\'équipe de Belgique.'.match(/\S+\s*/g);
const quote29 = 'La bataille de Drépane (ou Drepanum) est une bataille navale qui a lieu en 249 avant Jésus-Christ, lors de la première guerre punique, au large de Drépane (aujourd\'hui Trapani) à l\'ouest de la Sicile, entre une flotte carthaginoise commandée par Adherbal et une flotte romaine dirigée par Publius Claudius Puicher. Le consul romain tente de bloquer la forteresse carthaginoise de Lilybée (aujourd\'hui Marsala), mais sans réel succès, celle-ci étant toujours ravitaillée par voie maritime grâce aux connaissances locales d\'Hannibal le Rhodien sur les hauts-fonds du secteur. Pour arrêter ce ravitaillement, Publius Claudius Pulcher décide d\'attaquer la flotte punique qui se trouve dans le port de la ville voisine de Drépane.'.match(/\S+\s*/g);
const quote30 = 'La pluie de tes sarcasmes glisse sur la toile de mon indifférence.'.match(/\S+\s*/g);
const quote31 = 'Malgré tout cela, je crois encore à la bonté innée de l\'Homme.'.match(/\S+\s*/g);
const quote32 = 'Essayez de quitter la Terre un peu meilleure que vous l\'avez trouvée.'.match(/\S+\s*/g);
const quote33 = 'On ne voit bien qu\'avec le coeur. L\'essentiel est invisible pour les yeux.'.match(/\S+\s*/g);
const quote34 = 'Toutes les grandes personnes ont d\'abord été des enfants. Mais peu d\'entre elles s\'en souviennent.'.match(/\S+\s*/g);
const quote35 = 'Mais si tu m\'apprivoise, nous aurons besoin l\'un de l\'autre. Tu seras pour moi unique au monde. Et je serai pour toi unique au monde.'.match(/\S+\s*/g);
const quote36 = 'Que la lumière soit. Dixit euh... Dieu. Je citais Dieu.'.search(' ');
const quote37 = 'Vous êtes vous déjà dit qu\'il y a toujours un moment où l\'on entend son nom pour la dernière fois ? Et bien, ce moment est arrivé : je vais vous tuer, Chell.'.match(/\S+\s*/g);
const quote38 = 'Je n\'ai jamais imaginé qu\'on pût être à ce point hanté par une voix, par un cou, par des épaules, par des mains. Ce que je veux dire, c\'est qu\'elle avait des yeux où il faisait si bon vivre que je n\'ai jamais su où aller depuis.'.match(/\S+\s*/g);
const philoquote1 = 'La simplicité véritable allie la bonté à la beauté.'.match(/\S+\s*/g);
const philoquote2 = 'La justice de l\'intelligence est la sagesse. Le sage n\'est pas celui qui sait beaucoup de choses, mais celui qui voit leur juste mesure.'.match(/\S+\s*/g);
const philoquote3 = 'La victoire sur soi est la plus grande des victoires.'.match(/\S+\s*/g);
const philoquote4 = 'Celui qui progresse ne blâme personne, ne loue personne, ne critique personne, n\'incrimine personne. Il ne dit rien, ni de son importance, ni de son savoir.'.match(/\S+\s*/g);
const philoquote5 = 'Lorsque donc quelqu\'un te met en colère, sache que c\'est ton jugement qui te met en colère.'.match(/\S+\s*/g);
const philoquote6 = 'Il ne dépend pas de toi d\'être riche, mais il dépend de toi d\'être heureux.'.match(/\S+\s*/g);
const philoquote7 = 'La colère est nécessaire ; On ne triomphe de rien sans elle, si elle ne remplit l\'âme, si elle n\'échauffe le coeur ; Elle doit donc nous servir, non comme chef, mais comme soldat.'.match(/\S+\s*/g);
const philoquote8 = 'J\'entends par raison non pas la faculté de raisonner, qui peut être bien et mal employée, mais l\'enchaînement de vérités qui ne peut produire que des vérités, et une vérité ne saurait être contraire à une autre.'.match(/\S+\s*/g);
const philoquote9 = 'Je ne suis ni Athénien, ni Grec, mais citoyen du monde.'.match(/\S+\s*/g);
const philoquote10 = 'Je crois qu\'on ne peut mieux vivre qu\'en cherchant à devenir meilleur, ni plus agréablement qu\'en ayant la pleine conscience de son amélioration.'.match(/\S+\s*/g);
const philoquote11 = 'Les gens qu\'on interroge, pourvu qu\'on les interroge bien, trouvent d\'eux-mêmes les bonnes réponses.'.match(/\S+\s*/g);
const philoquote12 = 'Tu dois devenir l\'homme que tu es. Fais ce que toi seul peut faire. Deviens sans cesse celui que tu es, sois le maître et le sculpteur de toi-même.'.match(/\S+\s*/g);
const philoquote13 = 'Je peux douter de tout, sauf d\'une chose, et c\'est le fait même que je doute. Autrement dit - Je pense, donc je suis.'.match(/\S+\s*/g);
const philoquote14 = 'Pour atteindre la vérité, il faut une fois dans la vie se défaire de toutes les opinions qu\'on a reçues, et reconstruire de nouveau tout le sytème de ses connaissances.'.match(/\S+\s*/g);
const philoquote15 = 'La lecture de tous les bons livres est comme une conversation avec les plus honnêtes gens des siècles passés.'.match(/\S+\s*/g);

const enquote1 = 'Be proud of you, because you can be do what we want to do.'.match(/\S+\s*/g);
const enquote2 = 'Two things are infinite : the universe and human stupidity ; And i\'m not sure about the universe.'.match(/\S+\s*/g);
const enquote3 = 'How wonderful it is that nobody need wait a single moment before starting to improve the world.'.match(/\S+\s*/g);
const enquote4 = 'Never doubt that a small group of thoughtful, committed, citizens can change the world. Indeed, it is the only thing that ever has.'.match(/\S+\s*/g);
const enquote5 = 'One, remember to look up at the stars and not down at your feet. Two, never give up work. Work gives you meaning and purpose and life is empty without it. Three, if you are lucky enough to find love, remember it is there and don\'t throw it away.'.match(/\S+\s*/g);
const enquote6 = 'Mount Celeste is the unofficial name for a moutain located on Vancouver Island, British Columbia. It shares the name Celeste with two peaks in the Cariboo region of the BC Interior. Within the boundaries of Starhcona Provincial Park, this peak lies at the north end of Rees Ridge. Iceberg Peak lies at the south end of this ridge. The first ascent of this peak is cretited to Jack Horbury and Jock Sutherland on August 18, 1934. A ficitonal version of Mount Celeste is featured as the primary setting in the 2016 platforming game Celeste Classic and the 2018 platforming game Celeste. The game is about the personal struggles the main character Madeline faces as she attemps to climb to mountain. The moutain is also shown on the Instagram page of in-game character Theo.'.match(/\S+\s*/g);
const enquote7 = 'The 2003 London blackout was a serios power outage that affected parts of south London and north-west Kent in the evening of 28 August 2003. It was caused by a series of faults at National GRid transmission substations, which supplied the distribution network operateor in the area, EDF Energy (now UK Power Networks). It was the largest blackout in South East England since the Great Storm of 1986, affecting 476,000 customers. Power was lost at 18:20 BST and restored to EDF Energy 37 minutes later at 18:57, although it reportedly took longer for all customers to be reconnected.'.match(/\S+\s*/g);
const enquote8 = 'On 3 October 2023, a bus fell from an overpass in Mestre-Carpenedo, Venice, Veneto, Italy, and crashed, killing 21 people and injuring 18. The incident happened at 19:45 CEST as the bus was transporting tourists from Piazzale Roma in the historic centre of Venice to a campsite in the Maghera district.'.match(/\S+\s*/g);
const enquote9 = 'Despite everything, it\'s still you.'.match(/\S+\s*/g);
const enquote10 = 'I guess I should stop looking out for you, like I always do. When will you start lookin\' for me too, instead of leaving starin\' at my shoes ? Just the way, you\'re glancing at me, something about you just makes me feel guilty for liking you. When you\'re with him, when you\'re with him.'.match(/\S+\s*/g);
const enquote11 = 'Breaking Bad is an American crime drama television series created and produced by Vince Gilligan for AMC. Set and filed in Albuquerque, New Mexico, the series follows Walter White (Bryan Cranston), and underpaid, overqualified, and dispirited high-school chemistry teacher who is struggling with a recent disgnosis of stage-three lung cancer. White turns to a life of crime and partners with a former student, jesse Pinkman (Aaron Paul), to produce methamphetamine to secure his family\'s financial future before he dies, while navigating the dangers of the criminal underworld. Breaking Bad premiered on AMC on Janurary 20, 2008 and concuded on September 29, 2013, after five seasons consisting of 62 Episodes.'.match(/\S+\s*/g);
const enquote12 = 'And I guess, I\'ll just miss her, even if she isn\'t really gone, things are just different, ever since she cut her blue hair off.'.match(/\S+\s*/g);
const enquote13 = 'YOU! You\'re standing in the way of everybody\'s hopes and dreams!'.match(/\S+\s*/g);
const enquote14 = 'You never gained any LOVE, but you gained love.'.match(/\S+\s*/g);
const enquote15 = 'I gently open the door...'.match(/\S+\s*/g);
const enquote16 = 'It\'s dangerous to go alone ! Take this.'.match(/\S+\s*/g);
const enquote17 = 'The cake is a lie.'.match(/\S+\s*/g);
const enquote18 = 'For a moment, nothing happened. Then, after a second or so, nothing continued to happen.'.match(/\S+\s*/g);
const enquote19 = 'Space is big. You just won\'t believe how vastly, hugely, mind-bogglingly big it is. I mean, you may think it\'s a long way down the road to the chemist\'s, but that\'s just peanuts to space.'.match(/\S+\s*/g);
const enphiloquote1 = 'I think; therefore I am.'.match(/\S+\s*/g);
const enphiloquote2 = 'Conquer yourself rather than the world.'.match(/\S+\s*/g);
const enphiloquote3 = 'We can easily forgive a child who is afraid of the dark; the real tragedy of life is when men are afraid of the light.'.match(/\S+\s*/g);
const enphiloquote4 = 'I am the wisest man alive, for I know one thing, and that is that I know nothing.'.match(/\S+\s*/g);
const enphiloquote5 = 'Love is a serious mental disease.'.match(/\S+\s*/g);
const enphiloquote6 = 'If women are expected to do the same work as men, we must teach them the same things.'.match(/\S+\s*/g);
const enphiloquote7 = 'Excellence is never an accident. It is always the result of high intention, sincere effort, and intelligent execution; it represents the wise choice of many alternatives - choice, not chance, determines your destiny.'.match(/\S+\s*/g);
...
const tiplist = ['tip : appuyez sur ENTRÉE pour recommencer !', 'tip : utilisez tout vos doigts pour taper plus rapidement !', 'tip : Celeste est mon jeu préféré !'];
...
const entiplist = ['tip : press enter to restart quickly !', 'tip : use all your fingers to type !', 'tip : celeste is an awesome game !'];
